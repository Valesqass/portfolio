...
import { OrbitControls, Float, Stars, Torus, Box, Icosahedron } from '@react-three/drei';
...
const Home = () => {
    ...
    return (
        <div className="flex flex-col">
            {/* Hero Section */}
            <section id="home" className="relative w-full h-screen overflow-hidden flex flex-col justify-center bg-white text-black">
                {/* 3D Background */}
